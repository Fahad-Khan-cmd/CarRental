...
public class MonthlyReportUI {
    ...
    private final String[] columnNames = {"Booking Id", "Customer Name", "Vehicle Name", "Booking Date", "Complete Date", "Price", "Commission", "Status"};
    private String[][] data;
    ...
    private void updateTableData() {
        Date startDate = (Date) startDateChooser.getDate();
        Date endDate = (Date) endDateChooser.getDate();

        // Fetch data from the database based on the selected start and end dates
        data = reportService.getAllBookingForJTableFromStartDateTillEndDate(
    ...
    private void generatePdf() {
        try {
            ...
            Phrase heading = new Phrase("Monthly Report", headingFont);
